 ...
 */
 ...
 struct sigregs {
     ...
     int   sr_di;
     int   sr_bp;
     int   sr_st; //stck top --used in kernel
     int   sr_bx;
     int   sr_dx;
     int   sr_cx;
     int   sr_retreg;
 ...
 struct sigcontext {
     ...
     struct sigregs sc_regs; //registre set to restore
 };
...
#define SC_SIGCONTEXT   2
#define SC_NOREGLOCALS  4
